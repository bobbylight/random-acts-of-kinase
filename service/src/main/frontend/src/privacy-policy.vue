<template>
    <v-container grid-list-md class="page-wrapper">
        ...
        <v-row>
            ...
            <v-col class="privacy-policy-section">

                <p>At Random Acts of Kinase, accessible from https://randomactsofkinase.org/,
                    one of our main priorities is the privacy of our visitors. This Privacy Policy document
                    contains types of information that is collected and recorded by Random Acts of Kinase and
                    how we use it.</p>
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                    website with regards to the information that they shared and/or collect in Random Acts of
                    Kinase. This policy is not applicable to any information collected offline or via channels
            ...
            <sub-header>Consent</sub-header>
            <v-col class="privacy-policy-section">
                <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
            </v-col>

            <sub-header>Information we collect</sub-header>
            <v-col class="privacy-policy-section">
            ...
            <sub-header>How we use your information</sub-header>
            <v-col class="privacy-policy-section">
            ...
            <sub-header>Log Files</sub-header>
            <v-col class="privacy-policy-section">
                <p>Random Acts of Kinase follows a standard procedure of using log files. These files log visitors when
            ...
            <sub-header>Cookies and Web Beacons</sub-header>
            <v-col class="privacy-policy-section">
                <p>Like any other website, Random Acts of Kinase uses 'cookies'. These cookies are used to store
            ...
            <sub-header>Advertising Partners Privacy Policies</sub-header>
            <v-col class="privacy-policy-section">
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Random
                    Acts of Kinase.</p>

                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Random Acts of Kinase, which
                ...
                <p>Note that Random Acts of Kinase has no access to or control over these cookies that are used by
                    third-party advertisers.</p>
            </v-col>

            <sub-header>Third Party Privacy Policies</sub-header>
            <v-col class="privacy-policy-section">
                <p>Random Acts of Kinase's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <sub-header>CCPA Privacy Rights (Do Not Sell My Personal Information)</sub-header>
            <v-col class="privacy-policy-section">
            ...
            <sub-header>GDPR Data Protection Rights</sub-header>
            <v-col class="privacy-policy-section">
            ...
            <sub-header>Children's Information</sub-header>
            <v-col class="privacy-policy-section">
                ...
                <p>Random Acts of Kinase does not knowingly collect any Personal Identifiable Information from children
