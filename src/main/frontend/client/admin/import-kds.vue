<template>
    <v-container grid-list-md>
        <v-layout row wrap class="import-kd-wrapper">

            <section-header>Import K<sub>d</sub>s</section-header>

            <v-flex xs12 v-if="!file">

                <div>Upload a CSV file with K<sub>d</sub> information to add it to the database.
                ...
                <div class="headers-example">
                    <img src="img/import-kd-headers.png">
                </div>

                <v-checkbox class="import-kd-form-field"
                    disabled
